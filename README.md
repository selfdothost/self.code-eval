...
> **self.code-eval** — the catch-all harness for **code-focused** evaluation
> tasks in the self.ai stack. It is a fully vendored, GPLv3-relicensed fork of the
...
> [`NOTICE`](NOTICE) for provenance and [`LICENSE`](LICENSE) (GPLv3); the original
> Apache-2.0 text is retained in `LICENSE.bigcode-apache-2.0`.
